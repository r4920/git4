...
beforeAll(async function (){
  try {
    ...
    inserted_user = await user.insertOne({
      username: 'Allen_Adams',
      password: 'NUvDSiGBd3sL4j5',
      email: 'Audrey.Hand27@gmail.com',
      name: 'Esther Armstrong',
      mobileNo: '1-494-415-0217 x8240',
      userType: 690,
      resetPasswordLink: {},
      loginRetryLimit: 273,
      loginReactiveTime: '2022-07-31T20:19:07.192Z',
      id: '6228570ebcd2775ead6f09d4'
    });
  }
  catch (err) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Larue.King6',
        'password':'G6aJY3zq6FEgJtt',
        'email':'Ciara60@gmail.com',
        'name':'Hannah Langosh',
        'mobileNo':'663.869.1644',
