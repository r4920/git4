...
beforeAll(async function (){
  try {
    ...
    inserted_user = await user.insertOne({
      username: 'Alysha.Funk',
      password: '_3Ab2dKjtgXEFEI',
      email: 'Amya93@gmail.com',
      name: 'Clarence Bergnaum',
      mobileNo: '1-638-609-3995 x5765',
      userType: 780,
      resetPasswordLink: {},
      loginRetryLimit: 341,
      loginReactiveTime: '2022-08-06T19:20:24.016Z',
      id: '6228570ebcd2775ead6f09b0'
    });
  }
  catch (err) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Bernadine71',
        'password':'GQGO5Fx8cd38hfc',
        'email':'Shanel63@hotmail.com',
        'name':'Miriam Franecki',
        'mobileNo':'850-512-2196',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    ...
    let user = await request(app)
      .post('/admin/auth/forgot-password')
      .send({ 'email':'Shanel63@hotmail.com', });
